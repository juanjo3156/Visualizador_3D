...
public class MyCanvas extends GLCanvas implements GLEventListener, KeyListener {
    ...
    GLUT glut;
    Object3d obj1, obj2,obj4,obj5,obj6,obj7;
    ...
    public void init(GLAutoDrawable glad) {
        ...
        try {
            obj1 = or.Load("./Objetos/helmet.obj");
       ...
       try {
            obj4 = or.Load("./Objetos/rose.obj");
            System.out.println("Objeto 4 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }    
        
        try {
            obj5 = or.Load("./Objetos/Tree.obj");
            System.out.println("Objeto 5 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        } 
        
       /* try {
            obj6 = or.Load("./Objetos/helmet.obj");
            System.out.println("Objeto 6 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }*/
        try {
            obj7 = or.Load("./Objetos/House.obj");
            System.out.println("Objeto 7 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }
    ...
    public void display(GLAutoDrawable glad) {
       ...
       if (obj4 != null) {
            gl.glTranslatef(pox, poy+35.0f, poz);        
            gl.glRotatef(rotate, 0.0f, 1.0f, 0.0f);
            gl.glScalef(0.3f, 0.3f, 0.3f);
            obj4.draw(gl);
        }
        ...
        if (obj5 != null) {
            gl.glTranslatef(pox+60.0f, poy-40.0f, poz-20.0f);        
            gl.glRotatef(rotate, 0.0f, 1.0f, 0.0f);
            gl.glScalef(170.0f, 170.0f, 170.0f);
            obj5.draw(gl);
        }
        
        
       /*if (obj6 != null) {
            gl.glTranslatef(pox+7.0f, poy, poz+10.0f);        
            gl.glRotatef(rotate, 0.0f, 1.0f, 0.0f);
        ...
        if (obj7 != null) {
            gl.glTranslatef(pox-190.0f, poy, poz-110.0f);        
            gl.glRotatef(rotate, 0.0f, 1.0f, 0.0f);
